...
#define EVAL_COM0_CLK                    RCC_APB1Periph_USART2
#define EVAL_COM0_TX_PIN                 GPIO_Pin_5
#define EVAL_COM0_TX_GPIO_PORT           GPIOD
#define EVAL_COM0_TX_GPIO_CLK            RCC_AHB1Periph_GPIOD
#define EVAL_COM0_TX_SOURCE              GPIO_PinSource5
#define EVAL_COM0_TX_AF                  GPIO_AF_USART2
#define EVAL_COM0_RX_PIN                 GPIO_Pin_6
#define EVAL_COM0_RX_GPIO_PORT           GPIOD
#define EVAL_COM0_RX_GPIO_CLK            RCC_AHB1Periph_GPIOD
#define EVAL_COM0_RX_SOURCE              GPIO_PinSource6
#define EVAL_COM0_RX_AF                  GPIO_AF_USART2
#define EVAL_COM0_IRQn                   USART2_IRQn
