...
#define NATIVE_METHOD_PRINT_LONG    8
...
#define NATIVE_METHOD_APPEND_LONG   7
#define NATIVE_METHOD_APPEND_DOUBLE 8
...
// java/lang/exception
#define NATIVE_CLASS_EXCEPTION			(NATIVE_CLASS_BASE+29)

// java/lang/Thread
#define NATIVE_CLASS_THREAD			(NATIVE_CLASS_BASE+33)
#define NATIVE_METHOD_THREAD_INIT	0
#define NATIVE_METHOD_THREAD_RUNNABLE	2
#define NATIVE_METHOD_THREAD_START	3
