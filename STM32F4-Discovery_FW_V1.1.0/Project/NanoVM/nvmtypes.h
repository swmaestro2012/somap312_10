...
typedef s16_t nvm_short_t;
typedef s08_t nvm_byte_t;
typedef s64_t nvm_long_t;
typedef u64_t nvm_ulong_t;
typedef u64_t nvm_ref64_t;
typedef u64_t nvm_stack64_t;
/*
typedef struct _s_nvm_long_t
{
	u32_t l;
	s32_t h;
}nvm_long_t;
typedef struct _s_nvm_ulong_t
{
	u32_t l;
	u32_t h;
}nvm_ulong_t, nvm_ref64_t, nvm_stack64_t; */// needed for >>> operator
# ifdef NVM_USE_FLOAT
typedef float nvm_float_t;
# endif
typedef double nvm_double_t;
