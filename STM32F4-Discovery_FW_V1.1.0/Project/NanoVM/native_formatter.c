...
void native_formatter_invoke(u08_t mref) {
  ...
  id = heap_alloc(FALSE, len + add + fmtdscr.pre_len + fmtdscr.post_len + 1);
  memoffset = (char*)stack_peek_addr(0)-(char*)fmt;
  fmt+=memoffset;
