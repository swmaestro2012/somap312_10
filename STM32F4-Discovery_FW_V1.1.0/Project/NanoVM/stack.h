...
void stack_push64(nvm_stack64_t val);
...
# endif
nvm_long_t stack_pop_long(void);
nvm_long_t stack_peek_long(u08_t index);

nvm_double_t stack_pop_double(void);
nvm_double_t stack_peek_double(u08_t index);
