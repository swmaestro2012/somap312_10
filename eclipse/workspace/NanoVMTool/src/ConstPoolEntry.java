...
public final class ConstPoolEntry implements Cloneable {
	...
	public boolean equals(Object o) {
		...
		return (other.intValue == intValue && other.longValue == longValue
				&& other.index1 == index1 && other.index2 == index2
				&& other.floatValue == floatValue && other.doubleValue == doubleValue);
	}
	...
	public ConstPoolEntry setUTF(String value) {
		...
		stringValue = value;
		if (null == stringValue)
			throw new ConstPoolEntryError(
					"ConstPoolEntry.setUTF called with null string");
		return this;
	}
	...
	/**
	 * For INT, LONG, FLOAT, DOUBLE, UTF, or UNICODE entries, returns an
	 * Integer, Long, Float, Double, or String, respectively.
	 */
	...
	private ConstPoolEntryError getError(String method) {
		return new ConstPoolEntryError(method
				+ " called on ConstPoolEntry with typecode " + typecode());
	}

	public void read(DataInput in, ConstPoolEntry entry) throws IOException {
